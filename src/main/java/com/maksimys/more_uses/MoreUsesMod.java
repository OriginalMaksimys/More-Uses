package com.maksimys.more_uses;
...
@Mod("more_uses")
public class MoreUsesMod {
	public static final Logger LOGGER = LogManager.getLogger(MoreUsesMod.class);
	public static final String MODID = "more_uses";

	public MoreUsesMod(IEventBus modEventBus) {
